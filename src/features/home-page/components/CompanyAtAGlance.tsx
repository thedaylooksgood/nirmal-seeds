                ...
                <div className="section-container relative z-10">
                    ...
                    >
                        {companyGlanceData.items.map((item, index) => (
                            <div key={index} className="flex flex-col sm:flex-row items-center justify-center sm:justify-center text-center sm:text-left px-2 sm:px-4 h-full">
                                <div className="flex flex-row items-center justify-center md:justify-center text-left h-full select-none gap-3">
