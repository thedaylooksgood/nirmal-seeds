    ...
    return (
        <section className="w-full pt-10 pb-16 relative overflow-hidden" style={{ background: 'linear-gradient(to bottom, #dbebc7 0%, #ebf5df 40%, #ffffff 100%)' }}>
            <div className="w-full max-w-[1100px] mx-auto text-center px-4 md:px-0 relative">
                <Text as="h2" className="mb-6 lg:mb-8 mt-2 text-[#000000] font-light text-[36px] sm:text-[46px] md:text-[52px] xl:text-[56px] tracking-normal uppercase">
                    AWARDS & <span className="font-bold">ACHIEVEMENTS</span>
                </Text>

                <div className="relative w-full">
                    <GenericCarousel
                        options={{ align: "start", loop: true, slidesToScroll: 1 }}
                        navigationClassName="!bg-black hover:bg-black/90 !rounded-none !w-9 !h-9 sm:!w-11 sm:!h-11 !border-none !text-nirmal-yellow !opacity-100 !visible z-20 flex items-center justify-center top-[40%] -translate-y-1/2"
                        prevButtonClassName="!left-0 xl:-left-3"
                        nextButtonClassName="!right-0 xl:-right-3"
                        className="py-1 mx-auto w-full px-12 sm:px-14 md:px-16"
                        slideClassName="md:flex-[0_0_50%] px-2 md:px-3"
                        iconStrokeWidth={4}
                    >
