// CSR @ Nirmal Page Data

export const csrHeroData = {
    breadcrumb: [
        { label: "Home", href: "/" },
...
export const csrContentData = {
    title: "CSR:",
    titleHighlight: "GROWING RESPONSIBILITY",
    subtitle: "Soil, Nutrition & Knowledge Transfer",
    paragraphs: [
        "Nirmal Seeds approaches CSR as meaningful, on-ground action. The company works with ICRISAT and HarvestPlus to promote iron and pearl millet, fighting hidden hunger while raising farm incomes through better crop value.",
        "Farmer engagement includes meetings, front-line demonstrations and R&D center visits to keep scientific support practical and reachable.",
    ...
    image: "https://images.unsplash.com/photo-1605000780447-ca90695de96b?q=80&w=2070&auto=format&fit=crop",
...
export const communityData = {
    ...
    imageLeft: "https://images.unsplash.com/photo-1536640712-4d4c36ff0e4e?q=80&w=2070&auto=format&fit=crop",
    imageLeftAlt: "Clean drinking water support",
    imageRight: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=2070&auto=format&fit=crop",
    ...
    paragraphsRight: [
        ...
        "Additional interventions include providing stretcher trolleys and computers to PHCs, supporting mosquito-control measures during pandemics, contributing to PM and CM Care Funds, organizing eye-operation camps, and distributing cycles for the differently abled.",
        "Bus stops in rural areas have also been supported to enhance community accessibility and safety.",
    ],
}
