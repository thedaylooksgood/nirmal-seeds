...
export const productsContentData = {
    ...
    introParagraph:
        'Nirmal Seeds offers a comprehensive portfolio of <strong>177+ seed products</strong> across <strong>35+ crops</strong>, developed through decades of rigorous research and field testing. Our seeds are engineered for <strong>high yield, disease resistance, and climate adaptability</strong>, ensuring farmers get the best results across diverse agro-climatic zones.',
    categories: [
        {
            title: "Field Crops",
